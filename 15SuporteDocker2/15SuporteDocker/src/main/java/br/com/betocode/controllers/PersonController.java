...
public class PersonController {
	...
	@ApiOperation("Retorna todas as pessoas com mesmo trecho de nome.")
	...
	@ApiOperation("Retorna a pessoa pelo seu ID.")
	...
	@ApiOperation("Inclui uma pessoa na listagem (O ID é gerado automaticamente).")
	...
	@ApiOperation("Altera os atributos de uma pessoa (O ID deve ser informado).")
	...
	@ApiOperation("Altera o status de enabled para falso.")
	...
	@ApiOperation("Altera o status de enabled para verdadeiro.")
	...
	public PersonVO enablePerson(@PathVariable("id") Long id) {
		PersonVO personVO = service.enablePerson(id);
		personVO.add(linkTo(methodOn(PersonController.class).findById(id)).withSelfRel());
		return personVO;
	}
	
	@ApiOperation("Exclui uma pessoa da listagem (O ID deve ser informado).")
	@DeleteMapping("/{id}")
